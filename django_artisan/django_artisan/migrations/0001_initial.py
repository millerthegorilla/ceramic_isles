...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', safe_imagefield.models.SafeImageField(allowed_extensions=None, check_content_type=False, max_length=250, max_size_limit=False, media_integrity=False, scan_viruses=False, upload_to=django_artisan.models.user_directory_path)),
                ...
                ('shop_link', models.CharField(blank=True, default='', max_length=50)),
                ('shop_link_title', models.CharField(blank=True, default='', max_length=30)),
                ('active', models.BooleanField(default=False)),
                ('del_id', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
