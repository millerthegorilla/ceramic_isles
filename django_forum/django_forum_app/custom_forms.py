...
class CustomUserCreationForm(UserCreationForm):
    ...
    def clean_username(self):
        ...
        if fuzz.ratio(username, self['display_name'].value()) > 69:
            self.add_error('username', 'Error! your username is too similar to you display name')
            self.valid = False
        return username
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['rules'] = fields.BooleanField(
                label='<span class="text-white">I have read and agree with the <a class="text-white" target="blank" href="/users/rules/">Rules</a></span>')
        ...
        self.helper.layout = Layout(
                HTML('<span class="text-white">Your display name will be shown \
                ...
                HTML('<span class="text-white">Your username is used purely \
